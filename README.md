...
> **[v1.5.0-dev.1](https://github.com/mvaishak/letterboxd-morphe-patches/releases/tag/v1.5.0-dev.1)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;6 patches total
<details open>
...
| [Hide ratings until watched](#hide-ratings-until-watched) | Hides the community rating (average + histogram) on a film's page until you have marked that film as watched. Only the film page is affected — ratings shown in lists, search and elsewhere are unchanged. |  |
